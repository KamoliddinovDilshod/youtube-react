...
import Gussie from "../../assets/images/Gussie.jpg";
import Nora from "../../assets/images/Nora.jpg";
      ...
      <ul className='nav__list'>
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Home</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Trending</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Subscriptions</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Library</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>History</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Watch later</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Favourites</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Music</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/channel'>
            ...
            <strong className='nav__title'>Games</strong>
          </NavLink>
        </li>
        ...
        <li className='nav__item'>
          <NavLink className='nav__link' to='/'>
            ...
            <strong className='nav__title'>Show more</strong>
          </NavLink>
        </li>
      </ul>

      <h3 className='nav__subtitle'>Subscriptions</h3>

      <ul className='list nav__list'>
        <Item img={Gussie} title='Gussie Singleton' />
        <Item img={Nora} title='Nora Francis' />
        <Item img={Belle} title='Belle Briggs' />
        <Item img={Eunice} title='Eunice Cortez' />
        <Item img={Emma} title='Emma Hanson' />
        <Item img={Leah} title='Leah Berry' />
      </ul>

      <div className='nav__trunk'>
        <NavLink className="nav__trunk-link" to='/'>
          <svg
            width='19'
            height='20'
            fill='none'
          ...
          <span className="nav__trunk-title">Setting</span>
        </NavLink>
      </div>
    </nav>
  );
